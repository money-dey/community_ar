# Community AR — Detailed Roadmap

Comprehensive development roadmap for the library, organized into **eight phases** and grouped by status *(shipped, planned)* and functional area.

Use this as the source of truth when updating the README, marketing pages, or pub.dev description.
...
- Multi-class segmentation support (background, hair, body-skin, face-skin, clothes — Phase 3 planned)
...
- Declarative `EffectGraph` with linear effect chain
...
### Color math
- Oklab perceptual color space for all recolor operations
- sRGB ↔ linear ↔ Oklab conversion inline in shaders
...
### Phase 3 — Effect composition & beautification
- Multi-effect composition with dependency-aware ordering
- Shared mask resources across effects (deduplication)
- Multi-band frequency separation skin beautification
- Pore-level detail preservation with wrinkle attenuation
- Specular control (matte ↔ glow continuum)
- Tone-aware threshold scaling for diverse skin tones
- Temporal stabilization with motion gating and disocclusion guard
- Local exposure adaptation
- Quality tiers (auto, high, medium, low) for adaptive performance
